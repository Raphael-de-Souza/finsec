...
# ── Auto Scaling ─────────────────────────────────────────────────────────────
# NOTE: Commented out because the IAM user lacks application-autoscaling permissions
# (permissions boundary restriction). Uncomment when proper IAM access is available.
#
